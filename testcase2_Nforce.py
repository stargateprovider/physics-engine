...
engine.addCircle(radius=9, x=69, y=height-65, v=Vec2D(0,2), m=15, w=12, name="r9m15",color=(0,125,0), restitution=.75)

for x in range(20, width-18, 41):
    engine.addCircle(radius=20, x=x, y=height, v=Vec2D(0,0), m=90, w=30, name="r19m9",color=(0,125,0), restitution=.75)
