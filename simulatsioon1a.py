...
width = 600
height = 450
engine = Engine(width, height, gravity=Vec2D(0,10), velBoundary=.00001, time_step=.015, fpsLimit=120, bgcolor=(0,0,0))
#engine.debug=True
...
engine.addWall(width, height-200, 0, height-2, name="wallDiagonal")
