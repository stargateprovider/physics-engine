...
width = 600
height = 450
engine = Engine(width, height, gravity=Vec2D(0,9.8), velBoundary=.00001, time_step=.5, fpsLimit=120, bgcolor=(0,0,0))
#engine.debug=True
...
engine.addWall(0, 0, 0, height, name="wallW", color=(0,0,0))
engine.addWall(width, height, 0, height, name="wallS")
engine.addWall(0, 0, width, 0, name="wallN", color=(0,0,0))
